...
using webProject1.Pages;
using static webProject1.Model.ActorModel;
using static webProject1.Model.DiscoverModel;
using static webProject1.Model.trendingModel;
using Discover = webProject1.Model.DiscoverModel.Discover;
